...
Waypoint p2 = { 1, 1, d2r(45) };             // Waypoint @ x=-1, y= 2, exit angle= 0 radians
Waypoint p3 = {  2, 2, d2r(45) };             // Waypoint @ x= 2, y= 4, exit angle= 0 radians
points[0] = p1;
points[1] = p2;
points[2] = p3;
...
// Max Jerk:            60 m/s/s/s
pathfinder_prepare(points, POINT_LENGTH, FIT_HERMITE_CUBIC, PATHFINDER_SAMPLES_FAST, 0.001, 15.0, 10.0, 60.0, &candidate);
...
void AutoMovement::TestDrive()
{
    ...
    EncoderConfig rightconfig = { leftencoder->GetPosition(), 42, wheel_circumference, 1.0, 0.0, 0.0, 1.0 / max_velocity, 0.0};  
